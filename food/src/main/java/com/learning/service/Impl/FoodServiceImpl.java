...
//		}
	...
	public Optional<Food> getFoodByFoodType(String foodType)
		...
		// TODO Auto-generated method stub
		Optional<Food> optional =  repository.findByFoodName(foodType);
		if(optional.isEmpty()) {
			throw new IdNotFoundException("foodType does not have any items");
		}
		else {
	...
	@Override
	public String updateUser(String id, Food food) throws IdNotFoundException {
		// TODO Auto-generated method stub
