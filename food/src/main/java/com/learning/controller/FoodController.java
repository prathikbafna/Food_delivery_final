...
public class FoodController {
	...
	//retrieve all records
		...
		//need to change the data type of getFoodByFoodType --> returns <List<List<Food>>>
		...
		public ResponseEntity<?> updateUser(@PathVariable("id") String id, @Valid @RequestBody Food food) throws IdNotFoundException{
			String result = foodService.updateUser(id,food);
			return ResponseEntity.ok(result);	
